...
<div class="span5">
    <div id="errorCountByAppContainer" class="jobChart" style="min-width: 200px; height: 300px;"></div>
    <script>
        $(function () {
            $('#errorCountByAppContainer').highcharts({
                chart: {
                ...
                title: {
                    text: '<p class="text-info text-center">Error Count by Application</p>'
                },
                tooltip: {
                ...
                series: [
                    {
                        ...
                        data: [
                            <% for (ApplicationJobsDTO appJobs : dashboardInstance.applicationJobs) { %>
                              { name: '${appJobs.application.name}', y: ${appJobs.failuresCount} , id: ${appJobs.application.id} },
                            <% } %>
                        ]
                    }
                ]
